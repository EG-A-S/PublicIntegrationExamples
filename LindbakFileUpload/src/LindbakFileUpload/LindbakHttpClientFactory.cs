...
{
    /// <summary>
    /// Factory for creating http clients that are granted access to Lindbak APIs.
    /// </summary>
    /// <remarks>
    ...
    /// </remarks>
    public class LindbakHttpClientFactory
    {
        ...
        /// </summary>
        /// <returns>JSON serializer using Lindbak conventions</returns>
        public static JsonSerializer CreateLindbakCloudBlobSerializer()
        {
        ...
        /// <summary>
        /// Initialized a new instance based on the provided Lindbak certificate.
        /// </summary>
        /// <param name="certificateCommonName">The common name part of the subject of the Lindbak certificate</param>
        public LindbakHttpClientFactory(string certificateCommonName)
        {
            _certificate = GetFromCertificateStore(certificateCommonName);

            var (authUrl, clientId) = GetDetailsFromLindbakCertificate(_certificate);
            _clientId = clientId;
